...
def test_registry_is_valid_and_only_contains_existing_implementations() -> None:
    ...
    assert {"validate_evaluator_semantics", "freeze_information_contract", "build_coverage_datasets", "materialize_all_sites", "materialize_canonical_units", "normalize_pgf1_evidence", "compute_pg_f1", "validate_pgf1_leaderboard_admission"}.issubset(ids)
