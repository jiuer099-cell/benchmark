...
rule materialize_all_sites:
    input:
        ...
        provenance_library=PROVENANCE_LIBRARY,
    output:
        vcf=f"{RESULTS_ROOT}/{SAMPLE_ID}/{OFFICIAL_MODE}/" + "{tool}/canonical/all-sites.vcf",
        addressability=f"{RESULTS_ROOT}/{SAMPLE_ID}/{OFFICIAL_MODE}/" + "{tool}/canonical/addressability.tsv",
